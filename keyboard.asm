...
handle_keystroke:
    mov ah, 0h             ; Get Keystroke (Blocking I think) return is in AL
    int 16h                ; Keyboard Interrupt
    cmp al, 8h             ; (ASCII) 8h = Backspace
    je .backspace_mod
    ...
    je .up
    call print_char
    inc byte [Cursor_X]    ; Typing a character moves the cursor, or mov Cursor_X, dl
